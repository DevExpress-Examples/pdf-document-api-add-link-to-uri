...
This sample project shows the PDF Document Facade API used to add an annotation linked to a URI string.
...
| C# | Visual Basic |
|---|---|
| [Program.cs](./CS/AddLinkToUri/Program.cs) | [Program.vb](./VB/AddLinkToUri/Program.vb) |
...
* [PDF Document API - Add a Link to a Page]( https://github.com/DevExpress-Examples/pdf-document-api-add-link-to-page)
